...
)
{
    ...
    MPI_Dist_graph_create_adjacent(
        ...
        send_ranks, MPI_UNWEIGHTED, mpi_info, reorder, &info->comm
    );
...
)
{
    ...
    void *recv_buf    = info->recv_buf;
    MPI_Neighbor_alltoallv(
        send_buf, send_sizes, send_displs, info->dtype, 
        recv_buf, recv_sizes, recv_displs, info->dtype, info->comm
    );
