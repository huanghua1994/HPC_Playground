...
VR = house_qr(A);
R  = triu(VR(1 : n, 1 : n));
Q1 = apply_house_Q_fwd(VR, IA);
Q2 = apply_house_Q_bwd(VR, IA);
Y1 = apply_house_Q_fwd(VR, X);
Y2 = apply_house_Q_bwd(VR, X);
...
VR = house_qr_WY(A, 16);
R  = triu(VR(1 : n, 1 : n));
Q3 = apply_house_Q_WY_fwd(VR, IA);
Q4 = apply_house_Q_WY_bwd(VR, IA);
Y3 = apply_house_Q_WY_fwd(VR, X);
Y4 = apply_house_Q_WY_bwd(VR, X);
