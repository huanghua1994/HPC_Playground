...
#define get_local_thread_id()  (blockDim.x * blockDim.y * threadIdx.z + blockDim.x * threadIdx.y + threadIdx.x)
#define get_global_thread_id() (blockDim.x * blockDim.y *  blockDim.z * get_block_id() + get_local_thread_id())
